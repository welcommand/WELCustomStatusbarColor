...
#import "WELStatusbarIconColor.h"
...
id wel_imageHook(id self, SEL _cmd, UIImage *image, UIImage *shadowImage) {
    UIColor *color = objc_getAssociatedObject([WELStatusbarIconColor class], @"wel_statusbarIconColor");
    if(color) {
...
@implementation WELStatusbarIconColor
